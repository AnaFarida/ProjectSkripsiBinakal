                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer" style="margin: 0rem;">
                                    <a type="button" class="btn btn-danger text-white" data-dismiss="modal" style="margin-bottom: .25rem;">Batal</a>
                        ...
                        foreach ($penggunaAll as $user) { ?>
                            <tbody>
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <a href="<?= base_url('Pengguna/detail/' . $user->id_nama) ?>" class="btn btn-primary btn-sm" type="button">
