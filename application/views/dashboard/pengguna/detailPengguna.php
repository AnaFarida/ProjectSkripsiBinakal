                                ...
                                <form action="" method="POST">
                                    <div class="card-body pt-0">
                                        <div class="row">
                                            <div class="col-7">
                                                ...
                                                <br>
                                                <p class="text-muted text-sm"><b>Dibuat: </b> <?= $user->created; ?>
                                                </p>
                                                <?php endforeach ?>
                                            </div>
                                            <div class="col-5 text-center">
                                                <img src="<?= base_url('assets/img/profile/admin.png')?>"
                                    ...
                                    <div class="card-footer">
                                        <div class="text-right">
                                            ...
                                            <button class="btn btn-icon btn-danger" type="submit" name="mati"
                                                id="mati"><i class="fas fa-minus"></i></span>
