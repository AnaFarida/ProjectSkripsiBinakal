                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="hidden" name="id_nama" id="id_nama" class="form-control" placeholder="Masukkan nama ..." value="<?= $detail[0]->id_nama; ?>">
                                <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan nama ..." value="<?= $detail[0]->nama; ?>">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" id="email" class="form-control" placeholder="Masukkan email ..." value="<?= $detail[0]->email; ?>">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="alamat" id="alamat" class="form-control" placeholder="Masukkan alamat ..." value="<?= $detail[0]->alamat; ?>">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nohp" id="nohp" class="form-control" placeholder="Masukkan no telepon ..." value="<?= $detail[0]->telepon; ?>">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="password" name="password2" id="password2" class="form-control" placeholder="Masukkan konfirmasi password ...">
