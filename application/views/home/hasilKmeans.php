            ...
            <div class="wants-wrapper w-padding2">
                <div class="row align-items-center justify-content-between">
                    <div class="col-xl-7 col-lg-9 col-md-8">
                        <legend style="font-weight: bold; border-radius: 5px; width: 200px; padding: 5px; background-color: #5AAC4E; color: #5AAC4E;">
                            ...
                            foreach ($centroid as $key => $value) {
                                ...
                                if ($short_cluster[$i] == $var) { ?>
                                    <div class="mb-4">
                                        ...
                                        <input type="text" class="form-control form-control-sm" value="<?= implode(", ", $value) ?>" readonly><?= $jumlah_per_centroid[$key] ?>
                        ...
                        <div class="card-body p-0">
                            ...
                            <table class="table table-striped">
                                <thead style="font-weight: bold; border-radius: 5px; width: 200px; padding: 5px; background-color:  #5AAC4E; color:  #5AAC4E;" class="text-white">
                                    <tr>
