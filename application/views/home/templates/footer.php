<footer>
    <div class="footer-wrappr section-bg3" data-background="<?= base_url(); ?>assets/assets/img/gallery/footer-bg.png">
...
<!-- Date Picker -->
<script src="<?= base_url(); ?>assets/assets/js/gijgo.min.js"></script>
<!-- Nice-select, sticky -->
...
<script src="<?= base_url(); ?>assets/assets/js/jquery.countdown.min.js"></script>
<script src="<?= base_url(); ?>assets/assets/js/hover-direction-snake.min.js"></script>
